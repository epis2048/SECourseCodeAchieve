...
public class RegistFrame extends JFrame {
	...
	// 确认和取消，按钮
	private JButton btnOk, btnCancle, btnToLogin;
	// 注册的用户
	...
	public RegistFrame() {
		...
		btnToLogin = new JButton("登录");
		btnToLogin.addActionListener(new ToLoginListener());
	...
	// 监听类，负责处理重置按钮
	public class ToLoginListener implements ActionListener {
		// 重写actionPerFormed()方法，重置组件内容事件处理方法
		public void actionPerformed(ActionEvent e) {
			new LoginFrame();
			dispose();
